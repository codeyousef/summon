...
class JsPlatformRenderer : PlatformRenderer {
    ...
    override fun getHeadElements(): List<String> {
        ...
        return js(
            "if (!window.summonHeadElements) { " +
                    "    window.summonHeadElements = []; " +
                    "} " +
                    "return window.summonHeadElements"
        ) as List<String>
    }
        ...
        when (type) {
            ...
            ProgressType.CIRCULAR, ProgressType.INDETERMINATE -> {
                if (value == null || type == ProgressType.INDETERMINATE) {
                    ...
                    js(
                        "var circularContainer = document.createElement('div'); " +
    ...
    override fun renderSwitch(
        ...
        js(
            "var switchContainer = document.createElement('label'); // Create a container for the switch " +
    ...
    override fun renderExpansionPanel(
        ...
        js(
            "var expansionPanel = document.createElement('div'); " +
    ...
    override fun renderLazyColumn(
        ...
        js(
            "var lazyColumn = document.createElement('div'); " +
    ...
    override fun renderLazyRow(
        ...
        js(
            "var lazyRow = document.createElement('div'); " +
    ...
    override fun renderResponsiveLayout(
        ...
        js(
            "var responsiveLayout = document.createElement('div'); " +
