...
class ColumnTest {
    ...
    fun testColumnWithDefaultModifier() {
        ...
        CompositionLocal.provideComposer(MockComposer()) {
            ...
            // Call the Column component with default modifier
            Column {
                // Empty content
            }
            ...
            assertEquals(expectedStyles, mockRenderer.lastModifier?.styles, "Modifier should have fillMaxSize applied")
    ...
    fun testColumnWithCustomModifier() {
        ...
        CompositionLocal.provideComposer(MockComposer()) {
            ...
            // Call the Column component with custom modifier
            ...
            assertEquals(expectedStyles, mockRenderer.lastModifier?.styles, "Modifier should be the custom one with fillMaxSize applied")
