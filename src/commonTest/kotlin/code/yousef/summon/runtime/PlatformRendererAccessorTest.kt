...
class PlatformRendererAccessorTest {
    ...
    fun testRendererFunctionality() {
        ...
        assertEquals(true, mockRenderer.renderTextCalled, "renderText should have been called")
        assertEquals("Hello", mockRenderer.lastText, "renderText should have received the correct text")

        // Reset tracking variables
        mockRenderer.renderTextCalled = false
        mockRenderer.lastText = ""

        // Test again with different text
        retrievedRenderer.renderText("World", Modifier())
        assertEquals(true, mockRenderer.renderTextCalled, "renderText should have been called again")
        assertEquals("World", mockRenderer.lastText, "renderText should have received the updated text")
    }
}
