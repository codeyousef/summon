...
// Deprecated margin extensions for backwards compatibility
@Deprecated("Use marginHorizontalAuto from AutoMarginModifiers", ReplaceWith("marginHorizontalAuto(value)"))
fun Modifier.marginHorizontalAuto(value: Number): Modifier = style("margin", "${value}px auto")

@Deprecated("Use marginVerticalAuto from AutoMarginModifiers", ReplaceWith("marginVerticalAuto(value)"))
fun Modifier.marginVerticalAuto(value: Number): Modifier = style("margin", "auto ${value}px")

@Deprecated("Use marginAuto from AutoMarginModifiers", ReplaceWith("marginAuto()"))
