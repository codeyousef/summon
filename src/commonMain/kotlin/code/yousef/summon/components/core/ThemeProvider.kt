 ...
 */
@Composable
fun code.yousef.summon.modifier.Modifier.themeColor(colorName: String): code.yousef.summon.modifier.Modifier {
    val theme = useTheme()
...
@Composable
fun code.yousef.summon.modifier.Modifier.themeBorder(): code.yousef.summon.modifier.Modifier {
    val theme = useTheme()
    return this.style("border", "1px solid ${theme.borderColor}")
}

@Composable
fun code.yousef.summon.modifier.Modifier.themeSpacing(size: String): code.yousef.summon.modifier.Modifier {
