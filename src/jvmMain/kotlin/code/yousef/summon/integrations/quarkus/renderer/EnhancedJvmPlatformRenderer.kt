...
class EnhancedJvmPlatformRenderer : PlatformRenderer() {
    ...
    override fun renderTextArea(value: String, onValueChange: (String) -> Unit, enabled: Boolean, readOnly: Boolean, rows: Int?, maxLength: Int?, placeholder: String?, modifier: Modifier) {
        super.renderTextArea(value, onValueChange, enabled, readOnly, rows, maxLength, placeholder, processModifier(modifier))
    }
    ...
    override fun renderRadioButton(checked: Boolean, onCheckedChange: (Boolean) -> Unit, label: String?, enabled: Boolean, modifier: Modifier) {
