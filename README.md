...
```bash
# Download summon-cli-0.4.5.1.jar

# Run commands directly
java -jar summon-cli-0.4.5.1.jar init my-app
java -jar summon-cli-0.4.5.1.jar --help
```
...
java -jar summon-cli/build/libs/summon-cli-0.4.5.1.jar init my-app
```
...
java -jar summon-cli-0.4.5.1.jar init portal

# Or skip the prompts entirely
java -jar summon-cli-0.4.5.1.jar init landing --mode=standalone --here
java -jar summon-cli-0.4.5.1.jar init portal --mode=fullstack --backend=ktor
...
dependencies {
  ...
  implementation("io.github.codeyousef:summon-js:0.4.5.1")

    // For WebAssembly projects
  implementation("io.github.codeyousef:summon-wasm-js:0.4.5.1")

    // For Kotlin Multiplatform projects (includes all targets)
  implementation("io.github.codeyousef:summon:0.4.5.1")
}
```
...
java -jar summon-cli-0.4.5.1.jar init my-wasm-app --mode=standalone
```
