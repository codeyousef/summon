...
> To:
> ```kotlin
    implementation("codes.yousef:summon:0.5.0.9")  // New - use this!
> ```
>
...
```bash
# Download summon-cli-0.5.0.9.jar
wget https://github.com/codeyousef/summon/releases/download/v0.5.0.9/summon-cli-0.5.0.9.jar

# Run it
java -jar summon-cli-0.5.0.9.jar init my-app
java -jar summon-cli-0.5.0.9.jar --help
...
java -jar summon-cli/build/libs/summon-cli-0.5.0.9.jar init my-app
```
...
java -jar summon-cli-0.5.0.9.jar init portal

# Or skip the prompts entirely
java -jar summon-cli-0.5.0.9.jar init landing --mode=standalone --here
java -jar summon-cli-0.5.0.9.jar init portal --mode=fullstack --backend=ktor
```
...
dependencies {
    ...
    implementation("codes.yousef:summon-jvm:0.5.0.9")

    // For JavaScript/Browser projects
    implementation("codes.yousef:summon-js:0.5.0.9")

    // For WebAssembly projects
    implementation("codes.yousef:summon-wasm-js:0.5.0.9")
...
> your dependencies. Both group IDs will be published until version 0.5.0.2 for compatibility.
...
java -jar summon-cli-0.5.0.9.jar init my-wasm-app --mode=standalone
```
