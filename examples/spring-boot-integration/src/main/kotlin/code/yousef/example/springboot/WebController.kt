...
class WebController @Autowired constructor(
    ...
    fun home(): String {
        ...
        return try {
            ...
            renderFullPage(
                ...
                // Hero section
                HeroComponent("Spring Boot User")
                ...
                Div(
                    ...
                    SummonServerTimeComponent()
                    
                    // Features section
                    FeatureCardsComponent()
                    
                    // Interactive counter (will need hydration for client-side interactivity)
    ...
    fun todos(
        ...
        return try {
            // In a real app, you'd fetch todos from the database
            val initialTodos = listOf(
                Todo(1, "Complete Spring Boot integration", false),
                Todo(2, "Test Summon components", true),
                Todo(3, "Remove all HTML templates", false)
            )
            
            // Render complete HTML page using pure Summon components
            renderFullPage(
                renderer = summonRenderer.renderer,
                title = "Todo App - Spring Boot Summon Example"
            ) {
                TodosPage(
    ...
    fun auth(
        ...
        return try {
            ...
            renderFullPage(
                renderer = summonRenderer.renderer,
                title = "Login - Spring Boot Summon Example"
            ) {
                AuthPage()
            }
        } catch (e: Exception) {
