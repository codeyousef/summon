...
VALUES ('1', 'admin', '$2a$10$8jw.9MmH.xZkJXFXJlzJs.jYnMAhOyHRhHlSW1JjQGD5XL9BdHYBu', 'admin@example.com', 'Administrator', 'ADMIN', 'PUBLISHED', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);

-- Regular user (username: user, password: user123)
INSERT INTO users (id, username, password_hash, email, full_name, role, status, created_at, updated_at)
VALUES ('2', 'user', '$2a$10$RO5Ck6LlQrAZX.t0UT5zHe9o1AzLVXyD5.a0zRJ/aAcgKYcXhkqI.', 'user@example.com', 'Regular User', 'USER', 'PUBLISHED', CURRENT_TIMESTAMP, CURRENT_TIMESTAMP);
