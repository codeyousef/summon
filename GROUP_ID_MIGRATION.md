...
**Completion Date**: Version 0.5.2.8 (estimated Q1 2026)
...
### Phase 2: New Group Only (0.5.2.8 onwards)
...
dependencies {
    ...
    implementation("codes.yousef:summon-jvm:0.5.2.8")
}
```
...
```kotlin
dependencies {
    api("codes.yousef:summon:0.5.2.8")  // Use 'api' for libraries
}
```
...
### Issue: "Cannot resolve codes.yousef:summon:0.5.2.8"
...
configurations.all {
    resolutionStrategy {
        // Force new group ID
        force("codes.yousef:summon:0.5.2.8")
...
| 0.5.2.8        | ✅                    | ✅            | **Use codes.yousef**      |
| 0.5.2.8        | ✅                    | ✅            | **Use codes.yousef**      |
| 0.5.0.0        | ✅ FINAL              | ✅            | **Use codes.yousef**      |
| 0.5.2.8+       | ❌                    | ✅            | **Must use codes.yousef** |
...
### Q: What if I don't migrate before 0.5.2.8?
...
**A**: You have until we release 0.5.2.8 (estimated Q1 2026). However, we recommend migrating now to avoid issues later.
...
January 2026: 0.5.0.0 (FINAL version on old group ID)
    ↓
February 2026: 0.5.2.8 (NEW group ID only)
```
...
**Applies to**: Summon 0.5.2.8 and later
