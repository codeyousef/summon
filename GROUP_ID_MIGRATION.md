...
**Effective Date**: November 13, 2025 (Version 0.4.8.0)  
...
### Phase 1: Dual Publishing (Current - 0.4.8.0 through 0.5.0.0)
...
```kotlin
dependencies {
    api("codes.yousef:summon:0.4.8.0")  // Use 'api' for libraries
}
```
...
### Issue: "Cannot resolve codes.yousef:summon:0.4.8.0"
...
configurations.all {
    resolutionStrategy {
        // Force new group ID
        force("codes.yousef:summon:0.4.8.0")
...
```
November 2025: 0.4.8.0 released (dual publishing begins)
    ↓
...
**Applies to**: Summon 0.4.8.0 and later
