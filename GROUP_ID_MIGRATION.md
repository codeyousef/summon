...
### Phase 1: Dual Publishing (Current - 0.4.8.7 through 0.5.0.2)
...
- 0.4.9.4 ✅
- 0.5.0.0 ✅
- 0.5.0.2 ⚠️ FINAL version on old group ID
...
```kotlin
dependencies {
    api("codes.yousef:summon:0.5.0.2")  // Use 'api' for libraries
}
```
...
### Issue: "Cannot resolve codes.yousef:summon:0.5.0.2"
...
configurations.all {
    resolutionStrategy {
        // Force new group ID
        force("codes.yousef:summon:0.5.0.2")
...
| 0.5.0.2        | ✅ FINAL              | ✅            | **Use codes.yousef**      |
...
**A**: You'll be stuck on version 0.5.0.2 or earlier. To get newer versions, you'll need to migrate.
...
### Q: What happens to the old group ID after 0.5.0.2?
...
December 2025: 0.4.9.1 (dual publishing continues)
    ↓
January 2026: 0.5.0.2 (FINAL version on old group ID)
    ↓
...
**Applies to**: Summon 0.5.0.2 and later
