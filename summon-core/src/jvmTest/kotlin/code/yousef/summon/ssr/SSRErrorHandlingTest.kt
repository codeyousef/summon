...
class SSRErrorHandlingTest {
    ...
    fun testMemoryLeakPrevention() {
        ...
        repeat(5) { iteration ->
            ...
            assertTrue(html.contains("Heavy object size: 1000"), 
                "Iteration $iteration: Should render heavy object")
            assertTrue(html.contains("String ref: test-string"), 
    ...
    fun testConcurrentErrorHandling() {
        ...
        results.forEachIndexed { id, html ->
            assertTrue(html.contains("Concurrent component $id"), 
                "Result $id should have correct component")
            assertTrue(html.contains("State: concurrent-$id"), 
    ...
    fun testInvalidHTMLPrevention() {
        ...
        assertFalse(html.contains("<div>Embedded HTML</div>") && 
