    ...
    fun testSEOMetadataGeneration() {
        ...
        fun SEOOptimizedPage() {
            ...
            Column(modifier = Modifier()) {
                ...
                Text(
                    "Server-side rendering (SSR) is a technique where web pages are rendered on the server before being sent to the client. This approach has several benefits:",
                    modifier = Modifier()
                )
