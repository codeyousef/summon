...
class CompositionContextSSRTest {
    ...
    fun testCompositionLocalProviders() {
        ...
        assertTrue(
            html.contains("Local value: provided_value"),
    ...
    fun testRememberDuringSSR() {
        ...
        assertTrue(
            html.contains("Remembered: server_remembered_value"),
    ...
    fun testMutableStateDuringSSR() {
        ...
        assertTrue(
            html.contains("State: ssr_modified_value"),
    ...
    fun testComposerSlotManagement() {
        ...
        assertTrue(
            html.contains("Values: slot1, slot2, state_slot"),
