...
class SSRSEOCompatibilityTest {
    ...
    private fun TestSEOApplication() {
        ...
        renderer.renderDiv(codes.yousef.summon.modifier.Modifier()) {
            renderer.renderText("Welcome to WASM-powered Summon", codes.yousef.summon.modifier.Modifier())
        }
    }
    ...
    private fun TestFormApplication() {
        ...
        renderer.renderDiv(codes.yousef.summon.modifier.Modifier()) {
            renderer.renderText("<form method=\"post\" action=\"/submit\">", codes.yousef.summon.modifier.Modifier())
            renderer.renderText("<label for=\"name\">Name:</label>", codes.yousef.summon.modifier.Modifier())
            renderer.renderText(
                "<input type=\"text\" id=\"name\" name=\"name\">",
                codes.yousef.summon.modifier.Modifier()
            )
            renderer.renderText("<button type=\"submit\">Submit</button>", codes.yousef.summon.modifier.Modifier())
            renderer.renderText("</form>", codes.yousef.summon.modifier.Modifier())
        }
    }
    ...
    private fun TestStructuredDataApplication() {
        ...
        renderer.renderDiv(codes.yousef.summon.modifier.Modifier()) {
            renderer.renderText("<script type=\"application/ld+json\">", codes.yousef.summon.modifier.Modifier())
            renderer.renderText("{", codes.yousef.summon.modifier.Modifier())
            renderer.renderText("\"@context\": \"https://schema.org\",", codes.yousef.summon.modifier.Modifier())
            renderer.renderText("\"@type\": \"WebApplication\",", codes.yousef.summon.modifier.Modifier())
            renderer.renderText("\"name\": \"Test Application\"", codes.yousef.summon.modifier.Modifier())
            renderer.renderText("}", codes.yousef.summon.modifier.Modifier())
            renderer.renderText("</script>", codes.yousef.summon.modifier.Modifier())
            renderer.renderText(
                "<div itemscope itemtype=\"https://schema.org/WebApplication\">",
                codes.yousef.summon.modifier.Modifier()
            )
            renderer.renderText("<span itemprop=\"name\">Test App</span>", codes.yousef.summon.modifier.Modifier())
            renderer.renderText("</div>", codes.yousef.summon.modifier.Modifier())
        }
    }
