 ...
 * - Functions marked with [@Composable][codes.yousef.summon.annotation.Composable] describe UI structure
 * - [Composer][codes.yousef.summon.runtime.Composer] tracks composition state and dependencies
 * - [Recomposer][codes.yousef.summon.runtime.Recomposer] schedules updates when state changes
 * - Only changed parts of the UI are re-rendered for optimal performance
 *
 * ### Platform Abstraction
 * [PlatformRenderer][codes.yousef.summon.runtime.PlatformRenderer] provides a unified API that adapts to different platforms:
 ...
 * - [State][codes.yousef.summon.state.State] and [MutableState][codes.yousef.summon.state.MutableState] interfaces
 * - [mutableStateOf][codes.yousef.summon.state.mutableStateOf] creates reactive state holders
 * - [remember][codes.yousef.summon.runtime.remember] persists values across recomposition
 * - Property delegation for ergonomic state access
 *
 * ### Type-Safe Styling
 * [Modifier][codes.yousef.summon.modifier.Modifier] system provides compile-time safe styling:
 ...
 *
 * ### Core Packages
 * - [codes.yousef.summon.annotation] - Core annotations like [@Composable][codes.yousef.summon.annotation.Composable]
 * - [codes.yousef.summon.runtime] - Composition system and platform abstraction
 * - [codes.yousef.summon.state] - Reactive state management primitives
 * - [codes.yousef.summon.modifier] - Type-safe styling and attributes system
 *
 * ### Component Packages
 * - [codes.yousef.summon.components.foundation] - Foundational components like [ThemeProvider][codes.yousef.summon.components.foundation.ThemeProvider]
 * - [codes.yousef.summon.components.input] - Interactive components ([Button][codes.yousef.summon.components.input.Button], [TextField], etc.)
 * - [codes.yousef.summon.components.layout] - Layout containers ([Column], [Row], [Box])
 * - [codes.yousef.summon.components.display] - Display components ([Text], [Image], [Icon])
 * - [codes.yousef.summon.components.feedback] - User feedback ([Alert], [Loading], [Modal])
 * - [codes.yousef.summon.components.navigation] - Navigation elements ([Link], [NavLink])
 *
 * ### Feature Packages
 * - [codes.yousef.summon.routing] - File-based routing system
 * - [codes.yousef.summon.theme] - Theme management and design tokens
 * - [codes.yousef.summon.animation] - Animation and transition support
 * - [codes.yousef.summon.accessibility] - Accessibility features and ARIA support
 * - [codes.yousef.summon.validation] - Form validation framework
 * - [codes.yousef.summon.i18n] - Internationalization and localization
 * - [codes.yousef.summon.security] - Authentication and authorization
 * - [codes.yousef.summon.ssr] - Server-side rendering optimizations
 *
 * ## Advanced Features
 *
 * ### Effects System
