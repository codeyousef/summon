 ...
 *
 * @deprecated Use the @Composable annotation from codes.yousef.summon.annotation instead.
 * This interface is being phased out in favor of the annotation-based approach.
 */
@Deprecated(
    message = "Use the @Composable annotation from codes.yousef.summon.annotation instead",
    replaceWith = ReplaceWith(
        expression = "@Composable fun",
        imports = ["codes.yousef.summon.annotation.Composable"]
    )
)
