...
object StylingModifiers {
     ...
     */
    fun Modifier.color(value: codes.yousef.summon.core.style.Color): Modifier = style("color", value.toString())
     ...
     */
    fun Modifier.backgroundColor(value: codes.yousef.summon.core.style.Color): Modifier =
