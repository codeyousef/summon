...
import codes.yousef.summon.runtime.ComposerContext
...
class ComposableTest {
    ...
    fun testComposableWithParameters() {
        ...
        assertEquals(
            ...
            result,
            "compose should work with @Composable functions that take parameters"
        )
    }
    ...
    fun testComposableWithCustomObjects() {
        ...
        assertEquals(
            TestObject(2, "Modified: Test"),
            result,
            "compose should work with @Composable functions that handle custom objects"
        )
    }
