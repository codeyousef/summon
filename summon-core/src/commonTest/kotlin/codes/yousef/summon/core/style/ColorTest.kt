...
class ColorTest {
    ...
    fun testToRgbaString() {
        ...
        assertEquals(
            ...
            semiTransparentBlue.toRgbaString(),
            "RGBA string with alpha should match expected format"
        )
    }
    ...
    fun testToHexString() {
        ...
        assertEquals(
            "#0000ff80",
            semiTransparentBlue.toHexString(),
            "Hex string with alpha should match expected format"
        )
    }
    ...
    fun testToCssString() {
        ...
        assertEquals(
            "rgba(0, 0, 255, 0.5019608)",
            semiTransparentBlue.toCssString(),
            "toCssString with alpha should match expected format"
        )
        ...
        assertEquals(
            semiTransparentBlue.toRgbaString(),
            semiTransparentBlue.toCssString(),
            "toCssString should equal toRgbaString for semi-transparent color"
        )
    }
    ...
    fun testFromHex() {
        ...
        // Test invalid format
        assertFailsWith<codes.yousef.summon.core.error.ValidationException>("Invalid hex format should throw exception") {
            Color.fromHex("#XYZ")
        }

        assertFailsWith<codes.yousef.summon.core.error.ValidationException>("Invalid hex length should throw exception") {
            Color.fromHex("#12345")
        }
    }
