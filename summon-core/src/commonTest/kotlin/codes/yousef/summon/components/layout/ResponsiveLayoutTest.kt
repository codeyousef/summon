...
class ResponsiveLayoutTest {
    ...
    fun testResponsiveLayoutWithDefaultParameters() {
        ...
        runComposableTest(mockRenderer) {
            ...
            assertContains(
                mockRenderer.lastResponsiveLayoutModifierRendered?.attributes ?: emptyMap(),
                "data-client-detection"
            )
            assertEquals(
                "true",
                mockRenderer.lastResponsiveLayoutModifierRendered?.attributes?.get("data-client-detection")
            ) // Default is client-side detection
