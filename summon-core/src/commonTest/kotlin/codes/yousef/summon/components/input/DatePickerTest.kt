...
class DatePickerTest {
    ...
    fun testBasicDatePickerRendering() {
        ...
        assertEquals(
            ...
            mockRenderer.lastDatePickerModifierRendered?.styles,
            "Modifier styles mismatch"
        )
        assertEquals(
            expectedModifier.attributes,
            mockRenderer.lastDatePickerModifierRendered?.attributes,
            "Modifier attributes mismatch"
        )
    ...
    fun testDisabledDatePicker() {
        ...
        assertEquals(
            expectedModifier.styles,
            mockRenderer.lastDatePickerModifierRendered?.styles,
            "Disabled modifier styles mismatch"
        )
        assertEquals(
            expectedModifier.attributes,
            mockRenderer.lastDatePickerModifierRendered?.attributes,
            "Disabled modifier attributes mismatch"
        )
        ...
        assertEquals(
            originalValue,
            selectedDate,
            "onValueChange callback should not be invoked when the DatePicker is disabled"
        )
    }
