    ...
    fun testGetArrowStyles() {
        TooltipPlacement.values().forEach { placement ->
            ...
            when (placement) {
                TooltipPlacement.TOP -> {
                    assertTrue(
                        styles["bottom"] == "-6px" || styles["top"] == "100%",
                        "Incorrect top/bottom for $placement arrow"
                    )
                    assertTrue(
                        styles["border-color"]!!.contains("#333 transparent transparent transparent"),
                        "Incorrect border-color for $placement arrow"
                    )
                }

                TooltipPlacement.RIGHT -> {
                    assertTrue(
                        styles["left"] == "-6px" || styles["right"] == "100%",
                        "Incorrect left/right for $placement arrow"
                    )
                    assertTrue(
                        styles["border-color"]!!.contains("transparent #333 transparent transparent"),
                        "Incorrect border-color for $placement arrow"
                    )
                }
                ...
                TooltipPlacement.BOTTOM -> {
                    assertTrue(
                        styles["top"] == "-6px" || styles["bottom"] == "100%",
                        "Incorrect top/bottom for $placement arrow"
                    )
                    assertTrue(
                        styles["border-color"]!!.contains("transparent transparent #333 transparent"),
                        "Incorrect border-color for $placement arrow"
                    )
                }
                ...
                TooltipPlacement.LEFT -> {
                    assertTrue(
                        styles["right"] == "-6px" || styles["left"] == "100%",
                        "Incorrect left/right for $placement arrow"
                    )
                    assertTrue(
                        styles["border-color"]!!.contains("transparent transparent transparent #333"),
                        "Incorrect border-color for $placement arrow"
                    )
                }
            }
