...
class FileUploadTest {
    ...
    fun testBasicFileUploadRenderingAndCallback() {
        ...
        assertNotNull(
            mockRenderer.lastFileUploadReturnedTriggerFunctionRendered,
            "Renderer should return a trigger function"
        )

        // Verify the callback was passed to the renderer
        assertNotNull(
            mockRenderer.lastFileUploadOnFilesSelectedRendered,
            "Original onFilesSelected callback should be captured"
        )
    ...
    fun testStatefulFileUpload() {
        ...
        assertNotNull(
            mockRenderer.lastFileUploadOnFilesSelectedRendered,
            "Callback should be captured in stateful call"
        )
