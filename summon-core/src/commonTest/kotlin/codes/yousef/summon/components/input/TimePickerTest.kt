...
class TimePickerTest {
    ...
    fun testDisabledTimePicker() {
        ...
        assertEquals(
            originalValue,
            selectedTime,
            "onValueChange callback should not be invoked when the TimePicker is disabled"
        )
    }
    ...
    fun testStatefulTimePicker() {
        ...
        assertNotNull(
            mockRenderer.lastOnValueChange,
            "onValueChange callback should not be null for StatefulTimePicker"
        )
