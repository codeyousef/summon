...
object TestValidationMessages {
    const val REQUIRED_FIELD = codes.yousef.summon.validation.ValidationMessages.REQUIRED_FIELD
    const val INVALID_EMAIL = codes.yousef.summon.validation.ValidationMessages.INVALID_EMAIL
    const val MIN_LENGTH = codes.yousef.summon.validation.ValidationMessages.MIN_LENGTH_TEMPLATE
    const val MAX_LENGTH = codes.yousef.summon.validation.ValidationMessages.MAX_LENGTH_TEMPLATE
    const val INVALID_FORMAT = codes.yousef.summon.validation.ValidationMessages.INVALID_FORMAT
    const val MUST_BE_NUMBER = codes.yousef.summon.validation.ValidationMessages.MUST_BE_NUMBER
    const val MUST_BE_POSITIVE = codes.yousef.summon.validation.ValidationMessages.MUST_BE_POSITIVE
}
...
object TestSetup {
    ...
    fun createBasicTestEnvironment(): TestEnvironment {
        return TestEnvironment(
            ...
            renderer = codes.yousef.summon.runtime.MockPlatformRenderer()
        )
    }
...
data class TestEnvironment(
    ...
    val renderer: codes.yousef.summon.runtime.MockPlatformRenderer
)
