...
class AccessibilityModifiersTest {
    ...
    fun testDisabledModifier() {
        ...
        assertEquals(
            "",
            modifier.getAttribute("disabled"),
            "Disabled modifier should add disabled attribute."
        ) // Empty string value is convention
        assertEquals(
            "true",
            modifier.getAttribute("aria-disabled"),
            "Disabled modifier should set aria-disabled to true."
        )
    ...
    fun testAutoFocusModifier() {
        ...
        assertEquals(
            "",
            modifier.getAttribute("autofocus"),
            "AutoFocus modifier failed."
        ) // Empty string value is convention
    }
