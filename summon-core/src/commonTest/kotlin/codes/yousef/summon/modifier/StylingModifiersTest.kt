...
class StylingModifiersTest {
    ...
    fun testClipCircleWithCenterModifier() {
        ...
        assertEquals(
            ...
            modifier.styles["clip-path"],
            "clipCircle with center failed."
        )
    }
    ...
    fun testClipEllipseWithCenterModifier() {
        ...
        assertEquals(
            ...
            modifier.styles["clip-path"],
            "clipEllipse with center failed."
        )
    }
    ...
    fun testClipPolygonListModifier() {
        ...
        assertEquals(
            "polygon(${points.joinToString(", ")})",
            modifier.styles["clip-path"],
            "clipPolygon with list failed."
        )
    }
    ...
    fun testClipPolygonVarargModifier() {
        ...
        assertEquals(
            ...
            modifier.styles["clip-path"],
            "clipPolygon with vararg failed."
        )
    }
    ...
    fun testClipInsetWithDefaultsModifier() {
        ...
        assertEquals(
            ...
            modifier.styles["clip-path"],
            "clipInset with defaults failed."
        )
    }
    ...
    fun testClipInsetWithRoundModifier() {
        ...
        assertEquals(
            "inset($top $top $top $top round $round)",
            modifier.styles["clip-path"],
            "clipInset with round failed."
        )
    }
    ...
    fun testClipTriangleShapes() {
        ...
        assertEquals(
            ...
            leftModifier.styles["clip-path"],
            "clipTriangleLeft failed."
        )

        val rightModifier = Modifier().clipTriangleRight()
        assertEquals(
            "polygon(100% 50%, 0% 0%, 0% 100%)",
            rightModifier.styles["clip-path"],
            "clipTriangleRight failed."
        )
    }
    ...
    fun testClipComplexShapes() {
        ...
        assertEquals(
            ...
            diamondModifier.styles["clip-path"],
            "clipDiamond failed."
        )
        ...
        assertEquals(
            ...
            hexagonModifier.styles["clip-path"],
            "clipHexagon failed."
        )
    ...
    fun testClipArrowShapes() {
        ...
        assertEquals(
            ...
            rightArrowModifier.styles["clip-path"],
            "clipArrowRight failed."
        )

        val leftArrowModifier = Modifier().clipArrowLeft()
        assertEquals(
            "polygon(40% 0%, 40% 20%, 100% 20%, 100% 80%, 40% 80%, 40% 100%, 0% 50%)",
            leftArrowModifier.styles["clip-path"],
            "clipArrowLeft failed."
        )
    }
    ...
    fun testClipChevronShapes() {
        ...
        assertEquals(
            "polygon(75% 0%, 100% 50%, 75% 100%, 25% 100%, 50% 50%, 25% 0%)",
            rightChevronModifier.styles["clip-path"],
            "clipChevronRight failed."
        )

        val leftChevronModifier = Modifier().clipChevronLeft()
        assertEquals(
            "polygon(25% 0%, 0% 50%, 25% 100%, 75% 100%, 50% 50%, 75% 0%)",
            leftChevronModifier.styles["clip-path"],
            "clipChevronLeft failed."
        )
    }
