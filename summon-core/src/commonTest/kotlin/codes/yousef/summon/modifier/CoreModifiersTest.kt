...
class CoreModifiersTest {
    ...
    fun testAttributesProperty() {
        ...
        assertFalse(
            extractedAttributes.containsKey("background-color"),
            "background-color style should not be in attributes."
        )
    }
    ...
    fun testStylePrefixingLogic() {
        ...
        assertEquals(
            "value",
            m.style("margin", "value").styles["margin"],
            "Member style function should not prefix CSS."
        )
