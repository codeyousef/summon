...
class StylingModifierExtrasTest {
    ...
    fun testTextAlign() {
        ...
        assertEquals(
            stringValue,
            modifierString.styles["text-align"],
            "StylingModifierExtras.textAlign(String) failed."
        )
        ...
        assertEquals(
            enumValue.toString(),
            modifierEnum.styles["text-align"],
            "StylingModifierExtras.textAlign(Enum) failed."
        )
    }
