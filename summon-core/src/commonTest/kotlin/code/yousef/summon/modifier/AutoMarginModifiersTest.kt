...
class AutoMarginModifiersTest {
    ...
    fun testMarginHorizontalAuto_String() {
        ...
        val modifierStrDefault = Modifier().marginHorizontalAuto(vertical = "0px") // Explicitly call String version default
    ...
    fun testMarginVerticalAuto_String() {
        // Test default
        val modifierStrDefault = Modifier().marginVerticalAuto(horizontal = "0px") // Explicitly call String version default
