...
class FocusManagementTest {
    ...
    fun testCreateFocusPoint() {
        ...
        assertNull(focusPoint.styles["data-focus-restore"], "Focus point without restore should not have data-focus-restore")
        ...
        assertEquals("true", focusPointWithRestore.styles["data-focus-point"], "Focus point should have data-focus-point=true")
        assertEquals("true", focusPointWithRestore.styles["data-focus-restore"], "Focus point with restore should have data-focus-restore=true")
    }
