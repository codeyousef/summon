...
actual open class PlatformRenderer {
    ...
    actual open fun renderComposableRootWithHydration(composable: @Composable () -> Unit): String {
        ...
        rootElement.setAttribute("data-summon-version", js("globalThis.SUMMON_VERSION") ?: "0.4.5.0")
    ...
    actual open fun renderLoading(
        ...
        val sizeValue = when (size) {
            code.yousef.summon.components.feedback.LoadingSize.SMALL -> 16
            code.yousef.summon.components.feedback.LoadingSize.MEDIUM -> 24
            code.yousef.summon.components.feedback.LoadingSize.LARGE -> 32
            code.yousef.summon.components.feedback.LoadingSize.EXTRA_LARGE -> 48
        }
                        ...
                        createElement("div", dotsContainerModifier) {
                            repeat(3) { index ->
                                val dotModifier = Modifier()
                                    ...
                                    .style("border-radius", "50%")
                                    .style("animation", "summon-dot-pulse 1.4s ease-in-out ${index * 0.16}s infinite both")
