...
```bash
java -jar summon-cli-0.5.0.2.jar init portal --mode=fullstack --backend=quarkus  # Skip prompts
java -jar summon-cli-0.5.0.2.jar init marketing --mode=standalone --here          # Generate in current dir
```
...
```bash
java -jar summon-cli-0.5.0.2.jar init landing --mode=standalone
cd landing
...
```bash
java -jar summon-cli/build/libs/summon-cli-0.5.0.2.jar --help
```
