...
```bash
java -jar summon-cli-0.4.0.5.jar init my-web-app
cd my-web-app
...
```bash
java -jar summon-cli-0.4.0.5.jar create quarkus-app --name my-fullstack
cd my-fullstack
./gradlew quarkusDev
```
...
```bash
java -jar summon-cli-0.4.0.5.jar init wasm-app --template=wasm
cd wasm-app
...
```bash
java -jar summon-cli/build/libs/summon-cli-0.4.0.5.jar --help
```
...
java -jar summon-cli-0.4.0.5.jar install --global
```
