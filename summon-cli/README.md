...
```bash
java -jar summon-cli-0.4.0.8.jar <command>
```
...
```bash
java -jar summon-cli-0.4.0.8.jar init my-web-app
cd my-web-app
...
```bash
java -jar summon-cli-0.4.0.8.jar create quarkus-app --name my-fullstack
cd my-fullstack
./gradlew quarkusDev
```
...
```bash
java -jar summon-cli-0.4.0.8.jar init wasm-app --template=wasm
cd wasm-app
...
```bash
java -jar summon-cli/build/libs/summon-cli-0.4.0.8.jar --help
```
...
java -jar summon-cli-0.4.0.8.jar install --global
```
