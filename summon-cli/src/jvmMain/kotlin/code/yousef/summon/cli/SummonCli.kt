        ...
        if (currentContext.invokedSubcommand == null) {
            echo(
                ...
                📦 If you downloaded the JAR file:
                   java -jar summon-cli-0.4.5.0.jar init <name>
                
                Quick start:
                  1. Pick a project folder: --here, --dir <path>, or default subdirectory
                  2. Run `java -jar summon-cli-0.4.5.0.jar init <name>`
                ...
                Example (non-interactive):
                  ...
                  java -jar summon-cli-0.4.5.0.jar init landing-page --mode=standalone --here
