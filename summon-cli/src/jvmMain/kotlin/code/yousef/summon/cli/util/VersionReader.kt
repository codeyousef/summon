...
object VersionReader {
     ...
     *
     * @return The version string, or "0.4.4.0" as fallback
     */
    fun readVersion(): String {
        ...
        return try {
            ...
            if (versionFile == null) {
                println("Warning: version.properties not found, using fallback version 0.4.4.0")
                cachedVersion = "0.4.4.0"
                return cachedVersion!!
            }
     ...
     * Accepts formats like: 1.0.0, 1.0.0.0, 0.4.4.0
     */
