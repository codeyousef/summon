...
class ProjectGeneratorTest {
    ...
    fun `test version reads from version properties file`() {
        ...
        // Should use version from version.properties (0.4.9.0), not hardcoded 0.4.0.0
        assertFalse(
            content.contains("summon:0.4.0.0"),
            "Generated build file should not use hardcoded old version 0.4.0.0"
        )
        assertTrue(
            content.contains("summon:0.4.9.0"),
            "Generated build file should use current version 0.4.9.0 from version.properties"
        )
