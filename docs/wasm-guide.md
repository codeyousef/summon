...
Summon 0.4.8.7 introduces comprehensive WebAssembly support, bringing near-native performance to web applications while
...
java -jar summon-cli-0.4.8.7.jar init my-wasm-app --mode=standalone
...
kotlin {
    ...
    sourceSets {
        ...
        val wasmJsMain by getting {
            dependencies {
                // New group ID (preferred)
                implementation("codes.yousef:summon-wasm-js:0.4.8.7")
                // Legacy (deprecated; supported only until 0.5.0.0)
                // implementation("io.github.codeyousef:summon-wasm-js:0.4.8.7")
            }
        }
        ...
        val jvmMain by getting {
            dependencies {
                ...
                // Legacy (deprecated; supported only until 0.5.0.0)
                // implementation("io.github.codeyousef:summon-jvm:0.4.8.7")
            }
        }
    }
}
